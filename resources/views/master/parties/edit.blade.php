<x-app-layout><x-slot name="title">Edit Party</x-slot>
<div class="mb-3"><a href="{{ route('master.parties.index') }}" class="text-muted small text-decoration-none">← Parties</a></div>
<div class="card card-etrm" style="max-width:720px;"><div class="card-header">Edit Party</div><div class="card-body">
<form method="POST" action="{{ route('master.parties.update', $party) }}">@csrf @method('PUT')

<x-app-layout>
    <x-slot name="title">Edit Credit Warning Threshold</x-slot>
    ...
    <div class="card card-etrm" style="max-width:540px;">
        <div class="card-header fw-semibold">Edit Credit Warning Threshold</div>
        <div class="card-body">
            <form method="POST" action="{{ route('risk.credit-warnings.update', $threshold) }}">
                @csrf @method('PUT')
                <div class="row g-3">
                    <div class="col-12">
                        ...
                        <select name="party_id"
                            ...
                            <option value="{{ $party->id }}"
                                {{ old('party_id', $threshold->party_id) == $party->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <input type="number" name="warning_threshold_pct"
                                   ...
                                   value="{{ old('warning_threshold_pct', $threshold->warning_threshold_pct) }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <input type="number" name="breach_threshold_pct"
                                   ...
                                   value="{{ old('breach_threshold_pct', $threshold->breach_threshold_pct) }}"
                                   step="0.01" min="0" max="100">
                            <span class="input-group-text">%</span>
                        </div>
                ...
                <div class="d-flex gap-2 mt-4">
                    <button type="submit" class="btn btn-primary"
                            style="background:var(--etrm-secondary);border-color:var(--etrm-secondary);">Update Threshold</button>

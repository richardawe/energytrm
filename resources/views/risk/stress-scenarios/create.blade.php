<x-app-layout>
    <x-slot name="title">New Stress Scenario</x-slot>
    ...
    <div class="card card-etrm" style="max-width:760px;">
        <div class="card-header fw-semibold">New Stress Scenario</div>
        <div class="card-body">
            <form method="POST" action="{{ route('risk.stress-scenarios.store') }}">
                @csrf
                <div class="row g-3 mb-3">
                    <div class="col-12">
                        ...
                        <input type="text" name="name"
                               ...
                               placeholder="e.g. Oil Price Crash -30%">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="description" rows="2"
                                  ...
                                  placeholder="Describe the market scenario...">{{ old('description') }}</textarea>
                ...
                <div x-data="{ shocks: [{ index_id: '', price_shock_pct: '' }] }">
                ...
                <div class="d-flex gap-2 mt-4">
                    <button type="submit" class="btn btn-primary"
                            style="background:var(--etrm-secondary);border-color:var(--etrm-secondary);">Save Scenario</button>
                    <a href="{{ route('risk.stress-scenarios.index') }}" class="btn btn-outline-secondary">Cancel</a>
                </div>
            </form>
        </div>
    </div>
